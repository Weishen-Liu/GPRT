...
void
VulkanResources::createGeometry(int each_path) {
  // ------------------------------------------------------------------
  // triangle mesh
  // ------------------------------------------------------------------
  Geometry geometry;
  ...
  loadModel(configureImgui.LIST_OF_OBJS[each_path], geometry.list_of_vertices, geometry.list_of_indices,
            geometry.list_of_colors, geometry.list_of_vertex_normals);
